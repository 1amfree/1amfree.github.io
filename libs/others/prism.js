/* PrismJS 1.28.0
https://prismjs.com/download.html#themes=prism-solarizedlight&languages=markup+css+clike+javascript+bash+c+csharp+cpp+go+http+java+markup-templating+php+python+sql+uri+vim&plugins=custom-class+show-language+highlight-keywords+command-line+data-uri-highlight+toolbar */
